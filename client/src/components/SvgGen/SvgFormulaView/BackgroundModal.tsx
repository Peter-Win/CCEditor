...
export const BackgroundModal: React.FC<PropsBackgroundModal> = observer(
  ({ store }: PropsBackgroundModal) => {
      ...
      <>
        ...
        >
          <Alert
            showIcon
            type="warning"
            message="This color is not part of the SVG image. Used for viewing purposes only."
          />
          <div
            style={{
